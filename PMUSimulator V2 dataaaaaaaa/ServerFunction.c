	...
	while(1)	
	{
		...
		else		/* New datagram has been received */
		{
			...
			{	
                ...
                else if((c[1] & 0x0a) == 0x0a && (c[0] & 0x00) == 0x00)		 /* Command frame for Configuration frame-1 request from PDC */
                {
                ...
                else if((c[1] & 0x04) == 0x04 && (c[0] & 0x00) == 0x00)		 /* Command frame for Instantaneous Values request from PDC */
                {
